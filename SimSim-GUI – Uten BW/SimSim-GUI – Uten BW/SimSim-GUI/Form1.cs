...
namespace SimSim_GUI
{
    ...
    delegate void OppdaterGUIType(string s);
    delegate void OppdaterKnappType();
    ...
    public partial class Form1 : Form
    {
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            if (sp.IsOpen)
            {
                ...
                sKomThread = new Thread(HT);
                sKomThread.Start(null);
        ...
        void HT(object o)
        {
            while (kommunikasjonErPågående)
            {
                ...
                if (kommunikasjonErPågående)
                {
                    OppdaterGUIType ugd = OppdaterGUI;
                    this.Invoke(ugd, enMelding);
                }
            }

            sp.Close();
           
            OppdaterKnappType ukd = AktiverStartKnapp;
            this.Invoke(ukd, null);  
        }

        void AktiverStartKnapp()
        {
